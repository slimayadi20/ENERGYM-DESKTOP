...
public class Salle {
    ...
    public Salle(int id, String nom, String adresse, String tel, String mail, String description, String image, String prix1, String prix2, String prix3, String heureo, String heuref) {
        this.id = id;
        this.nom = nom;
        this.adresse = adresse;
        this.tel = tel;
    ...
    public Salle(String nom, String adresse, String tel, String mail, String description, String image, String prix1, String prix2, String prix3, String heureo, String heuref) {
        this.nom = nom;
        this.adresse = adresse;
        this.tel = tel;
        this.mail = mail;
