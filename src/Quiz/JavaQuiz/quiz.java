...
public class quiz {
    ...
    public static String[][] setQuiz0() {
        qpa[0][0] = "Quel est la salle la plus liké dans notre plateform?";
        qpa[0][1] = "Anas Plus";
        qpa[0][2] = "Slim Fit";
        qpa[0][3] = "California Gym";
        
        qpa[0][4] = "Skill Fit";
        qpa[1][0] = "Aprés l'inscription dans un evenement comment tu confirme ta participation? ";
        qpa[1][1] = "SMS";
        qpa[1][2] = "QR CODE";
        qpa[1][3] = "MAIL";
        qpa[1][4] = "Aucune Réponse";
         
         qpa[2][0]="Quelles sont les couleurs des cinq anneaux olympiques?";
         qpa[2][1]="Bleu, jaune, vert, rouge et noir,";
         qpa[2][2]="Bleu, jaune, vert, rouge et marron,";
         qpa[2][3]="Bleu, jaune, vert, rouge et orangé,";
         qpa[2][4]="Bleu, jaune, vert, rouge et violet ,";

         qpa[3][0]="Quelle est la durée d'un match de football ?;";
         qpa[3][1]="120 min";
         qpa[3][2]="90 min";
         qpa[3][3]="30 min";
         qpa[3][4]="45 min";

         qpa[4][0]="Combien de joueurs une équipe de football compte-t-elle sur le terrain?";
         qpa[4][1]="9";
         qpa[4][2]="22";
         qpa[4][3]="11";
         qpa[4][4]="10";

         qpa[5][0]="Qui a gagné la Coupe du monde 2010 ? ";
         qpa[5][1]="La France";
         qpa[5][2]="Bresil";
         qpa[5][3]="L'Espagne";
         qpa[5][4]="L'Italie";

         qpa[6][0]="Quelle équipe de Premier League a le plus de victoires en championnat ?";
         qpa[6][1]="Manchester United";
         qpa[6][2]="Chelsea ";
         qpa[6][3]="Manchester City";
         qpa[6][4]="Liverpool";

         qpa[7][0]="Combien de temps dure la prolongation d'un match de football?";
         qpa[7][1]="20 min";
         qpa[7][2]="15 min";
         qpa[7][3]="10 min";
         qpa[7][4]="30 min";

         qpa[8][0]="Pour quel club italien Diego Maradona a-t-il joué?";
         qpa[8][1]="Juventus";
         qpa[8][2]="AC Milan";
         qpa[8][3]="Inter Milan";
         qpa[8][4]="Napoli";

         qpa[9][0]="Qui est le meilleur buteur du FC Barcelone ?";
         qpa[9][1]="Messi";
         qpa[9][2]="Ronaldhinho";
         qpa[9][3]="Maradona";
         qpa[9][4]="E-Too";
